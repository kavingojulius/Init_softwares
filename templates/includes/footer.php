                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 mx-auto">
                            <form class="custom-form ebook-download-form bg-white shadow" action="#" method="post" role="form">
                                <div class="text-center mb-5">
                                    <h2 class="mb-1">Get your website now</h2>
                                </div>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <p class="copyright-text">Copyright © 2025 Init SoftWares
                            <br><br><a rel="nofollow" href="" target="_blank">designed by Init Sofwares</a></p>
                        </div>
